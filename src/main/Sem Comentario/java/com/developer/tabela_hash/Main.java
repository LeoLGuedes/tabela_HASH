...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int[] tamanho_tabelas = {1_000, 10_000, 100_000};
        int[] tamanho_dados = {100_000, 1_000_000, 100_000_000};
        ...
        for(int i=0; i<tamanho_dados.length; i++){
            for(int j=0; j<tamanho_dados[i]; j++){
                int numero = gerador.nextInt(Calculadora.potencia(10, numero_digitos));
        ...
        for(int i=0; i<tamanho_tabelas.length; i++){
            for(int j=0; j<tamanho_dados.length; j++){
